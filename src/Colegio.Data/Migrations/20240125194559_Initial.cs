    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnidadesEnsino", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnidadeEnsinoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "varchar(100)", nullable: true),
                    UpdatedDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "varchar(100)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Alunos_UnidadesEnsino_UnidadeEnsinoId",
                        column: x => x.UnidadeEnsinoId,
                        principalTable: "UnidadesEnsino",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coordenadores_UnidadesEnsino_UnidadeEnsinoId",
                        column: x => x.UnidadeEnsinoId,
                        principalTable: "UnidadesEnsino",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Professores_UnidadesEnsino_UnidadeEnsinoId",
                        column: x => x.UnidadeEnsinoId,
                        principalTable: "UnidadesEnsino",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Turmas_UnidadesEnsino_UnidadeEnsinoId",
                        column: x => x.UnidadeEnsinoId,
                        principalTable: "UnidadesEnsino",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alunos_UnidadeEnsinoId",
                table: "Alunos",
                column: "UnidadeEnsinoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coordenadores_UnidadeEnsinoId",
                table: "Coordenadores",
                column: "UnidadeEnsinoId");

            migrationBuilder.CreateIndex(
                name: "IX_Professores_UnidadeEnsinoId",
                table: "Professores",
                column: "UnidadeEnsinoId");

            migrationBuilder.CreateIndex(
                name: "IX_Turmas_UnidadeEnsinoId",
                table: "Turmas",
                column: "UnidadeEnsinoId");
        }
